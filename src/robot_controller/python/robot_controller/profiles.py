...
from item_perception_yolo.station_calibration import latest_station_calibration
...
def load_selection(item, bin_path, root, *, deployment=False):
    ...
    selected = Selection(Path(item).resolve(), profile, digest, template, station, deployment)
