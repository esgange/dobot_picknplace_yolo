...
STATES = (
    ...
    "HOLDING", "STOPPING", "RECOVERY_REQUIRED", "RECOVERING", "HELD_UNKNOWN",
    "FAULT",
)
...
_TRANSITIONS = {
    ...
    "READY": {"HOMING", "PICKING", "STOPPING", "RECOVERING", "HELD_UNKNOWN", "FAULT"},
    "HOMING": {"READY", "HOLDING", "STOPPING", "RECOVERY_REQUIRED", "HELD_UNKNOWN", "FAULT"},
    "PICKING": {"READY", "HOLDING", "STOPPING", "RECOVERY_REQUIRED", "HELD_UNKNOWN", "FAULT"},
    "HOLDING": {"HOMING", "STOPPING", "RECOVERING", "HELD_UNKNOWN", "FAULT"},
    "STOPPING": {"UNCONFIGURED", "INACTIVE", "RECOVERY_REQUIRED", "HELD_UNKNOWN", "FAULT"},
    "RECOVERY_REQUIRED": {"RECOVERING", "STOPPING", "FAULT"},
    "RECOVERING": {"READY", "HOLDING", "HELD_UNKNOWN", "STOPPING", "FAULT"},
